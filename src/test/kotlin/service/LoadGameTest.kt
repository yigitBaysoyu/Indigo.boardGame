...
class LoadGameTest {
     ...
     */
    private fun areGameStatesEqual(state1: IndigoGame, state2: IndigoGame): Boolean {
     ...
     */
    private fun arePlayerListsEqual(list1: List<Player>, list2: List<Player>): Boolean {
        if (list1.size != list2.size) return false
        return list1.zip(list2).all { (player1, player2) ->
